...
public class LivroNaoDidatico implements Livro{
    ...
    public LivroNaoDidatico(String codigo, String nome, String editora, String numEdicao,Sessao sessao,Controle controle) {
        this.codigo = codigo;
        this.nome = nome;
    ...
    public float chamadaPrecoLocacao(){
        return LivroNaoDidatico.getPrecoLocacao();
    }
    public float chamadaTaxaMultaDia(){
        return LivroNaoDidatico.getTaxaMultaDia();
    }
    public float chamadaTaxaDanoOuPerda(){
        return LivroNaoDidatico.getTaxaMultaDanoOuPerda();
    }

    public Period chamadaTempoEmprestimo(){
        return LivroNaoDidatico.getTempoEmprestimo();
    }
    ...
    public static void setTempoEmprestimo(int tempoEmprestimo) {
        LivroNaoDidatico.tempoEmprestimo = Period.ofMonths(tempoEmprestimo) ;
    }
    ...
    public static void setPrecoLocacao(float preco) {
        LivroNaoDidatico.precoLocacao = preco;
    }
    ...
    public static void setTaxaMultaDia(float taxaMultaDia) {
        LivroNaoDidatico.taxaMultaDia = taxaMultaDia;
    }
    ...
    public static void setTaxaMultaDanoOuPerda(float taxaMultaDanoOuPerda) { LivroNaoDidatico.taxaMultaDanoOuPerda = taxaMultaDanoOuPerda; }
